...
global.packname = "⍣هوتارو الوزير يروحي⍣" //ur sticker watermark packname
global.author = "⍣ 𝐇𝐨𝐭𝐚𝐫𝐨 𓆩🔮𓆪 𝐁𝐨𝐭⍣" //ur sticker watermark author
global.wm = "𝐢 𝐥𝐨𝐯𝐞 𝐮 ღ." //ur watermark
...
global.mess = {
    success: 'تم يروحي✨',
    admin: '『 الامر خاص فقط للادمن بس! 』',
    botAdmin: '『 ارفع البوت ل ادمن الاول 』',
    premime: '『 ميزات خاصة متميزة إذا كنت ترغب في تسجيل نوع الإيجار 』',
    owner: '『 هذه الميزة للمطور فقط! 』',
    group: '『 هذه الميزة للجروبات فقط! 』',
